 ...
 * @author edyos
 */
public class ControlNaveLanzadera implements ActionListener {
    
    private NaveLanzadera miNave;
    private ConsultasNaveLanzadera modC;
    private frmNaveLanzadera frm;
    ArrayList<NaveLanzadera> listaNaves;
     
    
    public ControlNaveLanzadera(NaveLanzadera miNave, ConsultasNaveLanzadera modC, frmNaveLanzadera frm) {
        this.miNave = miNave;
        this.modC = modC;
        this.frm = frm;
        ...
        this.frm.tblDatos.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt){
                ...
                if(evt.getClickCount()== 2){
                    ...
                    frm.txtCapCarga.setText(String.valueOf(frm.tblDatos.getValueAt(frm.tblDatos.getSelectedRow(), 6)));
                    frm.txtAltura.setText(String.valueOf(frm.tblDatos.getValueAt(frm.tblDatos.getSelectedRow(), 7)));
                }
    ...
    public void iniciar() {
        frm.setTitle("Naves Espaciales Lanzaderas");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == frm.btnRegistrar) {
            ...
            miNave.setCapacidadCarga(Integer.parseInt(frm.txtCapCarga.getText()));
            miNave.setAltura(Integer.parseInt(frm.txtAltura.getText()));
        ...
        if (e.getSource() == frm.btnConsultar) {
            ...
            if (modC.buscarNave(miNave)) {
                ...
                frm.txtCapCarga.setText(String.valueOf(miNave.getCapacidadCarga()));
                frm.txtAltura.setText(String.valueOf(miNave.getAltura()));
        ...
        if (e.getSource() == frm.btnListar) {
            ...
            for (NaveLanzadera listaNave : listaNaves) {   
                modelo.addRow(new Object[]{
                    ...
                    listaNave.getPotencia(), listaNave.getCombustible(), listaNave.getCapacidadCarga(),
                    listaNave.getAltura()
    ...
    public void limpiar() {
        ...
        frm.txtCapCarga.setText(null);
        frm.txtAltura.setText(null);
    }
